...
//        props.put("auto.offset.reset", "earliest");
    ...
    public void run(){ 
        ...
        System.out.println("*********ResultsOOOO********");   
        while(true){   
            if(it.hasNext()){ 
                //打印得到的消息   
                System.out.println(Thread.currentThread()+" get data:" +new String(it.next().message()) + " OOOO ");   
            } 
            try {   
                Thread.sleep(1000);   
    ...
    public static void main(String[] args) {   
        MyConsumer2 consumerThread = new MyConsumer2("zxyOO");   
